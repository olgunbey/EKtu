...
namespace EKtu.Persistence.Migrations
{
    ...
    [Migration("20240506125222_migrationLessonConfirmationTableAdded")]
    partial class migrationLessonConfirmationTableAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EKtu.Domain.Entities.ExamNote", b =>
                {
                    ...
                    b.Property<int>("LessonConfirmationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LessonConfirmationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("EKtu.Domain.Entities.LessonConfirmation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EKtu.Domain.Entities.ExamNote", b =>
                {
                    b.HasOne("EKtu.Domain.Entities.LessonConfirmation", "LessonConfirmation")
                        .WithOne("ExamNote")
                        .HasForeignKey("EKtu.Domain.Entities.ExamNote", "LessonConfirmationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LessonConfirmation");
                });
